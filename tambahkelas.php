                  ...
                  <p class="text-center wow bounceIn" data-wow-delay="0.4s">
                    ...
                    <div class="container">
                      <div class="form">
                        ...
                        <div class="col-xs-12">
                          <label for="usr">Nama Pelajaran:</label>
                          <input type="text" class="form-control" name="nama_pelajaran" placeholder="Nama pelajaran" required>
                        </div>
                      </div>
