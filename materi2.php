              ...
              <div class="well well-trans">
                <div class="wow fadeInRight" data-wow-delay="0.1s">
                  ...
                  <p class="text-center wow bounceIn" data-wow-delay="0.4s">
                    <a href="=<?=$row['id_materi']?>"><h5 class="h-light"><?=$row['judul_materi']?></h5>
                    <p><?=$row['isi']?> </p>
                    <p>
                      <?php
                    function youtube($url){
                      ...
                      $data='<object width="75%" height="75%"  data="http://www.youtube.com/v/'.$link.'" type="application/x-shockwave-flash">
