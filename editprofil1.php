      ...
      <div class="container navigation">
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#pelajar">Pelajar</a></li>
            <li><a href="#kelas">Kelas</a></li>
            <li><a href="#pengajar">Pengajar</a></li>
            <li><a href="#pengajar">Ujian</a></li>
          </ul>
          </div
      <!-- /.navbar-collapse -->
      </div>
                ...
                <div class="wow fadeInRight" data-wow-delay="0.1s">
                  ...
                  <ul class="lead-list">
                    ...
                    <p class="text-right wow bounceIn" data-wow-delay="0.4s">
                      <a href="pelajar1.php" class="btn btn-skin btn-lg">Update <i class="fa fa-angle-right"></i></a>
                    </p>
          ...
          <div class="col-sm-3 col-md-3">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="kelas-box">
                ...
                <div class="kelas-desc">
                  <a href="wabsite.php"><h5 class="h-light">website</h5>
                  </a>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="kelas-box">
                ...
                <div class="kelas-desc">
                  <a href=""><h5 class="h-light">Design</h5>
                  </a>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.3s">
              <div class="kelas-box">
                ...
                <div class="kelas-desc">
                  <a href=""><h5 class="h-light">Networking</h5>
                  </a>
          ...
          <div class="col-sm-3 col-md-3">
            ...
            <div class="wow fadeInRight" data-wow-delay="0.1s">
              <div class="kelas-box">
                ...
                <div class="kelas-desc">
                  <a href=""><h5 class="h-light">Database</h5>
                  </a>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.2s">
              <div class="kelas-box">
                ...
                <div class="kelas-desc">
                  <a href=""><h5 class="h-light">Keamanan Sistem</h5>
                  </a>
            ...
            <div class="wow fadeInRight" data-wow-delay="0.3s">
              <div class="kelas-box">
                ...
                <div class="kelas-desc">
                  <a href=""><h5 class="h-light">Artificial Intelligence</h5>
                  </a>
